...
public class Main {
  public static void main(String[] args) {
    ...
    XList<Integer> m3 = m2.union(Arrays.asList(ints)).union(XList.of(4, 4));
    ...
    System.out.println(lmod); //remove(index)- usuwa elemnt o danje pozycji,//remove(object) usuwa pierwszy napotkany element 
  }
}
