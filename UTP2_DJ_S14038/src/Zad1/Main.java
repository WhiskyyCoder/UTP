...
public class Main {
  public Main() {
    List<Integer> src1 = Arrays.asList(1,97,9,11,12); /*<-- tu dopisać inicjację elementów listy */
    System.out.println(test1(src1));

    List<String> src2 = Arrays.asList("a", "zzzz", "vvvvvvv","eeee");/*<-- tu dopisać inicjację elementów listy */
