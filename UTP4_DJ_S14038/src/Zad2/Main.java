...
public class Main {
  ...
  public static void main(String[] args) {
    SwingUtilities.invokeLater( ()-> {
        ...
        //Rzutowanie jest po to aby dac znac kompilatorwi ze MouseListener jest w MousePressListener(rozszerza),lambda jest traktowana jako obiekt wiec mozemy rzutowac
